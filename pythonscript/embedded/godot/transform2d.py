...
class Transform2D(BaseBuiltin):
    ...
    @classmethod
    def built_from_axis_origin(cls, x_axis=Vector2(), y_axis=Vector2(), origin=Vector2()):
        ...
        ret = Transform2D()
        lib.godot_transform2d_new_with_axis_origin(self._gd_ptr, x_axis._gd_ptr, y_axis._gd_ptr, origin._gd_ptr)
        return ret
