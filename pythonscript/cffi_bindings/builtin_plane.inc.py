class Plane(BaseBuiltin):
    ...
    def intersect_3(self, b, c):
        ...
        ret = Vector3()
        if not lib.godot_plane_intersect_3(self._gd_ptr, ret._gd_ptr, b._gd_ptr, c._gd_ptr):
            return None
        return ret
    ...
    def intersects_ray(self, from_, dir):
        ...
        ret = Vector3()
        if not lib.godot_plane_intersects_ray(self._gd_ptr, ret._gd_ptr, from_._gd_ptr, dir._gd_ptr):
            return None
        return ret
    ...
    def intersects_segment(self, begin, end):
        ...
        ret = Vector3()
        if not lib.godot_plane_intersects_segment(self._gd_ptr, ret._gd_ptr, begin._gd_ptr, end._gd_ptr):
            return None
        return ret
