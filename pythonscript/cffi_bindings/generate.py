...
EMBEDDING_INC_SOURCES = (
    ...
    'builtin_pool_color_array.inc.py',
    'builtin_pool_int_array.inc.py',
    'builtin_pool_real_array.inc.py',
    'builtin_pool_string_array.inc.py',
    'builtin_pool_vector2_array.inc.py',
    'builtin_pool_vector3_array.inc.py',
    'builtin_quat.inc.py',
