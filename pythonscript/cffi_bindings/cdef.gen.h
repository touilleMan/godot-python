...
godot_vector2 godot_vector2_linear_interpolate(godot_vector2 *p_self, const godot_vector2 *p_b, const godot_real p_t);
godot_vector2 godot_vector2_cubic_interpolate(godot_vector2 *p_self, const godot_vector2 *p_b, const godot_vector2 *p_pre_a, const godot_vector2 *p_post_b, const godot_real p_t);
godot_vector2 godot_vector2_rotated(godot_vector2 *p_self, const godot_real p_phi);
godot_vector2 godot_vector2_tangent(godot_vector2 *p_self);
godot_vector2 godot_vector2_floor(godot_vector2 *p_self);
godot_vector2 godot_vector2_snapped(godot_vector2 *p_self, const godot_vector2 *p_by);
...
godot_vector2 godot_vector2_slide(godot_vector2 *p_self, const godot_vector2 *p_n);
godot_vector2 godot_vector2_bounce(godot_vector2 *p_self, const godot_vector2 *p_n);
godot_vector2 godot_vector2_reflect(godot_vector2 *p_self, const godot_vector2 *p_n);
godot_vector2 godot_vector2_abs(godot_vector2 *p_self);
godot_vector2 godot_vector2_clamped(godot_vector2 *p_self, const godot_real p_length);
...
godot_rect2 godot_rect2_clip(godot_rect2 *p_self, const godot_rect2 *p_b);
godot_rect2 godot_rect2_merge(godot_rect2 *p_self, const godot_rect2 *p_b);
godot_bool godot_rect2_has_point(godot_rect2 *p_self, const godot_vector2 *p_point);
godot_rect2 godot_rect2_grow(godot_rect2 *p_self, const godot_real p_by);
godot_rect2 godot_rect2_expand(godot_rect2 *p_self, const godot_vector2 *p_to);
godot_bool godot_rect2_operator_equal(const godot_rect2 *p_self, const godot_rect2 *p_b);
godot_vector2 godot_rect2_get_pos(const godot_rect2 *p_self);
godot_vector2 godot_rect2_get_size(const godot_rect2 *p_self);
void godot_rect2_set_pos(godot_rect2 *p_self, const godot_vector2 *p_pos);
...
godot_basis godot_basis_rotated(godot_basis *p_self, const godot_vector3 *p_axis, const godot_real p_phi);
godot_basis godot_basis_scaled(godot_basis *p_self, const godot_vector3 *p_scale);
...
godot_vector3 godot_basis_xform(godot_basis *p_self, const godot_vector3 *p_v);
godot_vector3 godot_basis_xform_inv(godot_basis *p_self, const godot_vector3 *p_v);
...
godot_vector3 godot_vector3_snapped(godot_vector3 *p_self, const godot_real p_by);
godot_vector3 godot_vector3_rotated(godot_vector3 *p_self, const godot_vector3 *p_axis, const godot_real p_phi);
godot_vector3 godot_vector3_linear_interpolate(godot_vector3 *p_self, const godot_vector3 *p_b, const godot_real p_t);
godot_vector3 godot_vector3_cubic_interpolate(godot_vector3 *p_self, const godot_vector3 *p_b, const godot_vector3 *p_pre_a, const godot_vector3 *p_post_b, const godot_real p_t);
godot_real godot_vector3_dot(godot_vector3 *p_self, const godot_vector3 *p_b);
godot_vector3 godot_vector3_cross(godot_vector3 *p_self, const godot_vector3 *p_b);
godot_basis godot_vector3_outer(godot_vector3 *p_self, const godot_vector3 *p_b);
...
godot_vector3 godot_vector3_slide(godot_vector3 *p_self, const godot_vector3 *p_n);
godot_vector3 godot_vector3_bounce(godot_vector3 *p_self, const godot_vector3 *p_n);
godot_vector3 godot_vector3_reflect(godot_vector3 *p_self, const godot_vector3 *p_n);
...
godot_transform2d godot_transform2d_rotated(godot_transform2d *p_self, const godot_real p_phi);
godot_transform2d godot_transform2d_scaled(godot_transform2d *p_self, const godot_vector2 *p_scale);
godot_transform2d godot_transform2d_translated(godot_transform2d *p_self, const godot_vector2 *p_offset);
godot_transform2d godot_transform2d_interpolate_with(godot_transform2d *p_self, const godot_transform2d *p_m, const godot_real p_c);
...
godot_vector3 godot_plane_project(godot_plane *p_self, const godot_vector3 *p_point);
...
godot_vector3 godot_quat_xform(godot_quat *p_self, const godot_vector3 *p_v);
godot_quat godot_quat_slerp(godot_quat *p_self, const godot_quat *p_b, const godot_real p_t);
godot_quat godot_quat_slerpni(godot_quat *p_self, const godot_quat *p_b, const godot_real p_t);
godot_quat godot_quat_cubic_slerp(godot_quat *p_self, const godot_quat *p_b, const godot_quat *p_pre_a, const godot_quat *p_post_b, const godot_real p_t);
...
godot_string godot_rect3_as_string(godot_rect3 *p_self);
...
godot_rect3 godot_rect3_merge(godot_rect3 *p_self, const godot_rect3 *p_with);
godot_rect3 godot_rect3_intersection(godot_rect3 *p_self, const godot_rect3 *p_with);
...
godot_vector3 godot_rect3_get_support(godot_rect3 *p_self, const godot_vector3 *p_dir);
godot_vector3 godot_rect3_get_longest_axis(godot_rect3 *p_self);
...
godot_vector3 godot_rect3_get_shortest_axis(godot_rect3 *p_self);
...
godot_rect3 godot_rect3_expand(godot_rect3 *p_self, const godot_vector3 *p_to_point);
godot_rect3 godot_rect3_grow(godot_rect3 *p_self, const godot_real p_by);
godot_vector3 godot_rect3_get_endpoint(godot_rect3 *p_self, const godot_int p_idx);
...
godot_transform godot_transform_rotated(godot_transform *p_self, const godot_vector3 *p_axis, const godot_real p_phi);
godot_transform godot_transform_scaled(godot_transform *p_self, const godot_vector3 *p_scale);
godot_transform godot_transform_translated(godot_transform *p_self, const godot_vector3 *p_ofs);
godot_transform godot_transform_looking_at(godot_transform *p_self, const godot_vector3 *p_target, const godot_vector3 *p_up);
...
godot_color godot_color_linear_interpolate(godot_color *p_self, const godot_color *p_b, const godot_real p_t);
godot_color godot_color_blend(godot_color *p_self, const godot_color *p_over);
godot_string godot_color_to_html(godot_color *p_self, const godot_bool p_with_alpha);
...
godot_rect2 godot_image_get_used_rect(godot_image *p_self);
godot_image godot_image_get_rect(godot_image *p_self, const godot_rect2 *p_area);
godot_image godot_image_compressed(godot_image *p_self, const godot_int p_format);
godot_image godot_image_decompressed(godot_image *p_self);
godot_image godot_image_resized(godot_image *p_self, const godot_int p_x, const godot_int p_y, const godot_int p_interpolation);
godot_pool_byte_array godot_image_get_data(godot_image *p_self);
...
godot_image godot_image_converted(godot_image *p_self, const godot_int p_format);
...
godot_string godot_node_path_get_name(godot_node_path *p_self, const godot_int p_idx);
godot_int godot_node_path_get_subname_count(godot_node_path *p_self);
godot_string godot_node_path_get_subname(godot_node_path *p_self, const godot_int p_idx);
godot_string godot_node_path_get_property(godot_node_path *p_self);
