...
void godot_vector2_abs(godot_vector2 *p_dest, const godot_vector2 *p_src);
godot_real godot_vector2_angle(const godot_vector2 *p_src);
godot_real godot_vector2_angle_to(const godot_vector2 *p_src, const godot_vector2 *p_to);
godot_real godot_vector2_angle_to_point(const godot_vector2 *p_src, const godot_vector2 *p_to);
void godot_vector2_clamped(godot_vector2 *p_dest, const godot_vector2 *p_src, godot_real length);
void godot_vector2_cubic_interpolate(godot_vector2 *p_dest, const godot_vector2 *p_src, const godot_vector2 *p_b, const godot_vector2 *p_pre_a, const godot_vector2 *p_post_b, godot_real t);
godot_real godot_vector2_dot(const godot_vector2 *p_src, const godot_vector2 *p_with);
void godot_vector2_floor(godot_vector2 *p_dest, const godot_vector2 *p_src);
godot_real godot_vector2_aspect(const godot_vector2 *p_src);
void godot_vector2_linear_interpolate(godot_vector2 *p_dest, const godot_vector2 *p_src, const godot_vector2 *p_b, godot_real t);
void godot_vector2_reflect(godot_vector2 *p_dest, const godot_vector2 *p_src, const godot_vector2 *p_vec);
void godot_vector2_rotated(godot_vector2 *p_dest, const godot_vector2 *p_src, godot_real phi);
void godot_vector2_slide(godot_vector2 *p_dest, const godot_vector2 *p_src, godot_vector2 *p_vec);
void godot_vector2_snapped(godot_vector2 *p_dest, const godot_vector2 *p_src, godot_vector2 *p_by);
void godot_vector2_tangent(godot_vector2 *p_dest, const godot_vector2 *p_src);
void godot_vector2_to_string(godot_string *p_dest, const godot_vector2 *p_src);
...
void godot_vector3_rotated(godot_vector3 *p_dest, const godot_vector3 *p_src, const godot_vector3 *p_axis, godot_real phi);
void godot_vector3_linear_interpolate(godot_vector3 *p_dest, const godot_vector3 *p_src, const godot_vector3 *p_b, godot_real t);
void godot_vector3_cubic_interpolate(godot_vector3 *p_dest, const godot_vector3 *p_src, const godot_vector3 *p_b, const godot_vector3 *p_pre_a, const godot_vector3 *p_post_b, godot_real t);
void godot_vector3_cubic_interpolaten(godot_vector3 *p_dest, const godot_vector3 *p_src, const godot_vector3 *p_b, const godot_vector3 *p_pre_a, const godot_vector3 *p_post_b, godot_real t);
...
void godot_vector3_outer(godot_basis *dest, const godot_vector3 *p_src, const godot_vector3 *p_b);
void godot_vector3_to_diagonal_matrix(godot_basis *dest, const godot_vector3 *p_src);
...
godot_real godot_vector3_angle_to(const godot_vector3 *p_a, const godot_vector3 *p_b);
...
void godot_vector3_to_string(godot_string *p_dest, const godot_vector3 *p_src);
