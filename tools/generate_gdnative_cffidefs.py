...
def generate(header, godot_root):
    # header = '%s/modules/pluginscript/pluginscript.h' % godot_root
    gdnative_include = '%s/modules/gdnative/include/' % godot_root
...
if __name__ == '__main__':
    ...
    parser.add_argument('header', help='Path to header to flatten')
    ...
    with open(args.output, 'w') as fd:
        ...
        fd.write('/********************************************************/\n')
        fd.write(generate(args.header, args.godot_root_path))
