...
# Don't check autogenerated file in `cffi_binding`
FILES=$(git diff-tree --no-commit-id --name-only -r $RANGE | grep -v cffi_bindings | grep -E "\.(c|h|cpp|hpp|cc|hh|cxx|m|mm|inc)$")
echo "Checking files:\n$FILES"
