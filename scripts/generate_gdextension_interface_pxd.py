...
class CCCP:
    ...
    def handle_define_macro(self, line):
        ...
        define_value = line[len(match_define_macro.group(0)) :]  # noqa: F841
...
if __name__ == "__main__":
    ...
    source = args.input.read_text(encoding="utf8")

    # салют товарищ !
    cccp = CCCP(
        include_dirs=[args.input.parent],
    ...
    pxd_cdef = p.lines()
    # Remove the cdef part given we want to add the `nogil` option
    # and wchar_t&size_t are missing
